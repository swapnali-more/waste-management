...
export default function ReportPage() {
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
            ...
            <form className="bg-white p-8 rounded-2xl shadow-lg mb-12">
                <div className="mb-8">
                        ...
                        <div className="space-y-1 text-center">
                            ...
                            <div className="flex text-sm text-gray-600">
                                ...
                                >
                                    ...
                                    <input id="waste-image" name="waste-image" type="file" className="sr-only" accept="image/*" />
                                </label>
                ...
                <div className="mt-4 mb-8">
                    <img alt="Waste preview" className="max-w-full h-auto rounded-xl shadow-md" />
                </div>
